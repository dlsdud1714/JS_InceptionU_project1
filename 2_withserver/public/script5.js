...
const container = document.querySelector('.snacklist'); //ul
putMealList()
    ...
    try{
        ...
        for(let element of dataArray){
            ...
            if(nameValue == element.name ){
                ...
                let createdCalInfo = createCalBoardHTMLLunch(ChosenArray);
...
function createCalBoardHTMLLunch(item){
    if(item.carbCal===0 && item.proteinCal===0 && item.fatCal ===0){
        const comment = "I am not eating...";
