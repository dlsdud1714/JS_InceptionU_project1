...
async function putUserSetting(){
    ...
    try{
            ...
            getID.innerHTML= `<p>${UserData.Name}, Your set Calrories intake is <b>${UserData.GoalCalorie}cal</b>.</p><p>Try to manage Calorie ratios to meed</p><p> carbonate: <b>${UserData.CarbonateRatio}</b></p><p> Protein: <b>${UserData.ProteinRatio}</b></p><p> Fat: <b>${UserData.FatRatio}<b></p>`
    }catch{console.log}
